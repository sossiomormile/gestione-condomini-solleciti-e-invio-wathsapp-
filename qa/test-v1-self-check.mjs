...
try{execFileSync(process.execPath,['--check','v1-self-check.js'],{stdio:'pipe'});execFileSync(process.execPath,['--check','drive-sync-v2.js'],{stdio:'pipe'})}catch(e){fail('JavaScript syntax check failed: '+String(e.stderr||e.message))}
...
const app=read('app-current.html'),self=app.indexOf('v1-self-check.js?v=20260911-selfcheck1'),drive=app.indexOf('drive-sync-v2.js?v=20260911-fullrefresh2');
if(self<0||drive<0||self>=drive)fail('self-check must load before Drive V2');
